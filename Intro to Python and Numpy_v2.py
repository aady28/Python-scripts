...
def changeme( mylist ):
   ...
   lists = mylist.append([1,2,3,4])
   print ("Values inside the function: ", lists)
   return
...
arr = arr.reshape(3,2)                               # reshape matrix object
print(arr)

arr_t = arr.transpose()                               # reshape matrix object
print(arr_t)
...
print(arr.sum(axis = 0))                       # Sum of elements along columns
...
na = np.full([3,3], fill_value = np.nan)     # Custom Arrays
